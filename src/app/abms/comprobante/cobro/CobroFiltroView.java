...
public class CobroFiltroView extends ABMListadoFilterView implements FWBusquedas {
	
	
    public CobroFiltroView () {
        
    	super();
    	
    	// Seteo el título de la ventana
		this.setTitle("Filtro para el listado de Comprobantes de Cobro - Liquidación Cobranza");
	...
	private CCRow rPrincipal, rMensaje, rInquilino, rInmueble, rFechaDesde, rFechaHasta;
    ...
    public void find() {
    	...
    	int filtroIdInquilino = 0;
    	if (oInquilino != null) filtroIdInquilino =	oInquilino.getIdPersona();
    	...
    	CobroListadoView oPantallaListado = new CobroListadoView(filtroNroRecibo, filtroIdInquilino, filtroIdPropiedad, filtroFechaDesde, filtroFechaHasta);
