...
public class FacturaListadoModel extends AbstractTableModel { 
	...
	public Object getValueAt(int column, int row) {
		Factura currentObject = (Factura) dataList.get(row);
        ...
        switch (column) {
        	...
        	case 4: return currentObject.getFacturaTipoLetras() + " - " + Utiles.complete(currentObject.getNumero().toString(), 8);
