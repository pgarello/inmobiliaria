...
public class ContratoCtaCteView2 extends ABMListadoView {
	
	private List<ContratoNovedadPago> dataListPago;
	private Contrato oContrato;
	private CCTextField tMonto;
	ContratoCtaCteModel2 oModel = new ContratoCtaCteModel2();
	
    public ContratoCtaCteView2 (Contrato oContrato) {
        
    	super(null, false);
    	
    	// Seteo el título de la ventana
		this.setTitle("Cuenta Corriente del Contrato - Liquidación PAGO - IV");
    ...
    public void ActualizarDatos() {
         ...
         * a - 	Tengo que buscar primero los datos de las novedades de PAGO
         * 		Liquidación PAGO - Propietario
         */
    	    	    	
        //ContratoCtaCteModel oModel = new ContratoCtaCteModel();
    	short mes = 0, anio = 0;
        dataListPago = ContratoNovedadPagoProcesos.buscarNovedadesPagoPorContrato(this.oContrato, false, false, mes, anio);
