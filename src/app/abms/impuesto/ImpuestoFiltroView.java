...
public class ImpuestoFiltroView extends ABMListadoFilterView implements FWBusquedas {
    ...
    public ImpuestoFiltroView () {
        
    	super();
    	
    	// Seteo el título de la ventana
		this.setTitle("Filtro para el listado de Impuestos");
    ...
    public void find() {
    	...
    	if (contrato_ptr >= 0) {
	    	...
	    	ImpuestoListadoView oPantallaListado = new ImpuestoListadoView(oContrato);
        	...
        	((FWContentPanePrincipal) ApplicationInstance
                    ...
                    .abrirVentana(new FWWindowPaneMensajes("Error LISTADO DE IMPUESTOS","Debe seleccionar una contrato para continuar.",(short)1));
        }
