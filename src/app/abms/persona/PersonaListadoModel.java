...
public class PersonaListadoModel extends AbstractTableModel { 
	...
	public Object getValueAt(int column, int row) {
		...
		// La localidad puede no haber sido ingresada
		String localidad = "";
		try {
			localidad = currentObject.getLocalidad().getDescripcion();
		} catch (Exception e) {}
