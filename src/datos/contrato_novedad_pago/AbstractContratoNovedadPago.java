...
/**
 * AbstractContratoNovedadPago generated by MyEclipse Persistence Tools
 */

public abstract class AbstractContratoNovedadPago implements
		java.io.Serializable {

	// Fields

	private Integer idContratoNovedadPago;
	...
	/** default constructor */
	public AbstractContratoNovedadPago() {
	}

	/** minimal constructor */
	public AbstractContratoNovedadPago(Integer idContratoNovedadPago,
			Contrato contrato, Persona persona, Short idNovedadTipo,
			Date fechaAlta) {
		this.idContratoNovedadPago = idContratoNovedadPago;
	...
	public Integer getIdContratoNovedadPago() {
		return this.idContratoNovedadPago;
	}

	public void setIdContratoNovedadPago(Integer idContratoNovedadPago) {
		this.idContratoNovedadPago = idContratoNovedadPago;
	}
